...
```{r gif1.1, echo = F, results='asis',fig.cap="Evolución de la densidad sindical por sexo, países feminizados"}
...
```{r gif1.2, echo = F, fig.cap="Evolución de la densidad sindical por sexo, países masculinizados"}
...
```{r map view, results='asis', echo= F,  fig.cap="(ref:map1)"}
# Final Map
leaflet(map) %>% 
