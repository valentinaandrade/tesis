...
```{r fig10, echo = F,  fig.cap="(ref:fig10)"}
...
Pero como indicamos al inicio, a la fecha hay al menos 20 países que no han alcanzado la feminización (Figura \@ref(fig:fig11)). Entre ellos destacan diversos países como Francia (reconocido por su baja densidad sindical de cerca un 8% [@visser2002], pero con alta cobertura de la negociación colectiva), Argentina (nación latinoamericana destacada por su fuerte tradición sindical (cita)) y Alemania (país donde los trabajadores tienen un importante poder estructural).  
Ahora bien, entre en la Figura \@ref(fig:fig10) podemos notar una diferenciación de colores, que en resumidas palabras, indica si la variación de los últimos años es a favor de la feminización (coloreadas de púrpura) o a favor de la masculinización (coloreadas de celeste). Con esta información podemos vislumbrar que en los últimos años, al menos un 60% de los países masculinizados está en tendencia de feminizar su sindicalización. De hecho, países como Estados Unidos, Páises Bajos, Portugal, Suiza y Eslovaquia tienen una clara pendiente positiva hacia el aumento de mujeres en organizaciones sindicales. 


```{r, echo = F, fig.cap="(ref:fig11)"}
...
En la *Tabla 2* se reportan estadísticos descriptivos para todas las variables en análisis. 

La densidad sindical tiene una media de X, una Max
Variación y last fudi 
