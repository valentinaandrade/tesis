...
ggplot(c, aes(x=f_sector_SER, y=p, color = region)) +
   geom_point() +
   facet_wrap(.~ region) + ggsci::scale_color_futurama() + labs(x = "", y = "") + theme(legend.position = "none")

g1 <- c %>% filter(year >=1980& year <2000) %>% 
ggplot(aes(x=f_LFPR, y=p, color = region)) +
   geom_point() +
   facet_wrap(. ~ d_fudi) + ggsci::scale_color_futurama() + labs(x = "", y = "", title = "1980-1990 ") + theme(legend.position = "bottom")

g2 <- c %>% filter(year >=1970& year <=1990) %>% 
ggplot(aes(x=f_LFPR, y=p, color = region)) +
   geom_point() +
   facet_wrap(. ~ d_fudi) + ggsci::scale_color_futurama() + labs(x = "", y = "", title = "1990-2000 ") + theme(legend.position = "bottom")

g3 <- c %>% filter(year >=1990& year <=2000) %>% 
ggplot(aes(x=f_LFPR, y=p, color = region)) +
   geom_point() +
   facet_wrap(. ~ d_fudi) + ggsci::scale_color_futurama() + labs(x = "", y = "", title = "2000-2010") + theme(legend.position = "bottom")

g4 <- c %>% filter(year >=2010) %>% 
ggplot(aes(x=f_LFPR, y=p, color = region)) +
   geom_point() +
   facet_wrap(. ~ d_fudi) + ggsci::scale_color_futurama() + labs(x = "", y = "", title = "2010-2018") + theme(legend.position = "bottom")
