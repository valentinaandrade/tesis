...
Evolución de la feminización de la densidad sindical en países donde el último año la densidad sindical estuvo masculinizada. En color morado están indicados los países que tuvieron un △FUDi favorable a la feminización, mientras que en celeste aquellos que mantienen y profundizan la tendencia a la masculinización.
...
Chile y Nueva Zelanda son dos paises neoliberales

Comparten que su sindicalización se feminizó. 

Chile y Nueva Zelanda gran sector servicios y feminizado. Pese a coeficientes negativos. 

Además son sectores que crecen mucho y rapidamente: Chile X y Nueva Zelanda X. 

Sus organizaciones sindicales más fuertes son: X e Y. Si bien en Chile prevalecen las tradicionales en el ultimo tiempo toman fuerza (y nombrar)

Del mismo modo pasa con las de Nueva Zelanda

--> Hacer comentario similar al de MIlkman

### La permanencia de los sectores tradicionales: el caso japonés

Japón es un país 

- Sistema laboral vitalicio

- Recién en 2010 se flexibiliza. Se evidencia en que el régimen part time incluso solo empieza a ser legal el año 1993 (Ley de trabajo parcial PTWL) y si bien un 91% de ellas son mujeres, representan muy poco de la ufuerza de trabajo (14,7%) (fuente: Ministerio de Administración Pública, Asuntos Internos, Correos y Telecomunicaciones)


- De igual forma el sector más fuerte es: automóvil del Japón y el Sindicato de trabajadores del sector electrónico y de la información del Japón. Si bien estos ultimos son "comunicaciones" y podrían ser cat. servicios son sectores masculinizados. 

- Eso se expresa en que sus organizaciones sindicales más fuertes son:
De igual forma sindicatos a nivel empresa

- Habrá que esperar unos añospara ver que pasa ahora
